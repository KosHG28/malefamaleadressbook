package com.koshg.interlude.settings
...
import com.koshg.interlude.reminders.ReminderScheduler
...
import com.koshg.interlude.ui.theme.withPreset
...
class CyclePreferences(context: Context) {
    ...
    private fun Palette.launcherAliasClassName(): String = when (this) {
        Palette.WINE -> "com.koshg.interlude.LauncherWine"
        Palette.MIDNIGHT -> "com.koshg.interlude.LauncherMidnight"
        Palette.FOREST -> "com.koshg.interlude.LauncherForest"
        Palette.PLUM -> "com.koshg.interlude.LauncherPlum"
        Palette.GRAPHITE -> "com.koshg.interlude.LauncherGraphite"
    }
